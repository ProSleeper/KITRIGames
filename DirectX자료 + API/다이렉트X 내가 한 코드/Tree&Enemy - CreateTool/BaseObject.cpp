...
void BaseObject::Render()
{
	...
	//DEVICE->DrawPrimitiveUP(D3DPT_TRIANGLELIST, 1, &mArrVertexs, sizeof(D3DFVF_XYZ_COLOR));
...
BaseObject::BaseObject() : mvPos(0, 0, 0), mvOrgPos(0, 0, 0), mvRot(0, 0, 0), mvScale(1, 1, 1), mvDir(0, 0, 1), mvOrgDir(0, 0, 1), mEditOn(false), mbUse(true), mCrashSphere(nullptr), mRadius(0)
{
